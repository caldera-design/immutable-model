(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("caldera-immutable-model", [], factory);
	else if(typeof exports === 'object')
		exports["caldera-immutable-model"] = factory();
	else
		root["caldera-immutable-model"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Model = function () {
	    function Model(data) {
	        ...
	        } else if (_immutable.Map.isMap(data)) {
	            this.data = data;
	        } else {
	            this.data = new _immutable.Map(data);
	        }
	    }
	    ...
	    Model.prototype.setIn = function setIn(keyPath, value) {
	        return new this.constructor(this.data.setIn(keyPath, value));
	    };
	
	    Model.prototype.getIn = function getIn(keyPath) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _findIndex2 = __webpack_require__(129);
	...
	var _isUndefined = __webpack_require__(136);
	...
	var _remove2 = __webpack_require__(138);
	
	var _remove3 = _interopRequireDefault(_remove2);
	
	var _take2 = __webpack_require__(144);
	
	var _take3 = _interopRequireDefault(_take2);
	
	var _sortBy2 = __webpack_require__(145);
	
	var _sortBy3 = _interopRequireDefault(_sortBy2);
	
	var _reverse2 = __webpack_require__(161);
	
	var _reverse3 = _interopRequireDefault(_reverse2);
	
	var _uniqBy2 = __webpack_require__(162);
	
	var _uniqBy3 = _interopRequireDefault(_uniqBy2);
	
	var _slice2 = __webpack_require__(171);
	...
	var Collection = function () {
	    function Collection(data) {
	        ...
	        (0, _invariant2.default)(!(0, _isUndefined2.default)(this.constructor.Model), 'Model cannot undefined.');
	        if (data instanceof Collection) {
	            this.data = data.getData();
	        } else if (_immutable.List.isList(data)) {
	            this.data = data;
	        } else {
	            this.data = new _immutable.List((0, _map3.default)(data, function (d) {
	                var model = d instanceof _Model2.default ? d : new _this.constructor.Model(d);
	                return model;
	            }));
	        }
	    }
	
	    Collection.prototype.toJS = function toJS() {
	        return this.data.toJS();
	    };
	
	    Collection.prototype.set = function set(index, value) {
	        var model = value instanceof _Model2.default ? value : new this.constructor.Model(value);
	    ...
	    Collection.prototype.push = function push(value) {
	        var model = value instanceof _Model2.default ? value : new this.constructor.Model(value);
	    ...
	    Collection.prototype.remove = function remove(predicate) {
	        return new this.constructor((0, _remove3.default)(this.data.toArray(), predicate));
	    };
	
	    Collection.prototype.removeById = function removeById(id) {
	        return this.remove(function (item) {
	            return (0, _isFunction2.default)(item.getId) && item.getId() !== id;
	        });
	    };
	    ...
	    Collection.prototype.findIndexById = function findIndexById(id) {
	        return this.findIndex(function (item) {
	            return (0, _isFunction2.default)(item.getId) && item.getId() === id;
	        });
	    };
	
	    Collection.prototype.find = function find(predicate) {
	        return (0, _find3.default)(this.data.toArray(), predicate);
	    };
	
	    Collection.prototype.filter = function filter(predicate) {
	        return new this.constructor((0, _filter3.default)(this.data.toArray(), predicate));
	    };
	
	    Collection.prototype.findIndex = function findIndex(predicate) {
	        return (0, _findIndex3.default)(this.data.toArray(), predicate);
	    };
	
	    Collection.prototype.map = function map(predicate) {
	        return new this.constructor((0, _map3.default)(this.data.toArray(), predicate));
	    };
	
	    Collection.prototype.concat = function concat(collection) {
	        var collectionData = collection.toArray ? collection.toArray() : collection;
	        var data = new this.constructor(collectionData);
	        return new this.constructor(this.data.concat(data.toArray()));
	    };
	
	    Collection.prototype.addOrReplaceById = function addOrReplaceById(id, value) {
	    ...
	    Collection.prototype.getData = function getData() {
	        return this.data;
	    };
	
	    Collection.prototype.take = function take(n) {
	        return new this.constructor((0, _take3.default)(this.data.toArray(), n));
	    };
	
	    Collection.prototype.sortBy = function sortBy(predicate) {
	        return new this.constructor((0, _sortBy3.default)(this.data.toArray(), predicate));
	    };
	
	    Collection.prototype.reverse = function reverse() {
	        return new this.constructor((0, _reverse3.default)(this.data.toArray()));
	    };
	
	    Collection.prototype.uniqBy = function uniqBy(predicate) {
	        return new this.constructor((0, _uniqBy3.default)(this.data.toArray(), predicate));
	    };
	
	    Collection.prototype.removeDuplicates = function removeDuplicates() {
	        return this.uniqBy(function (a) {
	            return a.id || a.getId();
	        });
	    };
	    ...
	    Collection.prototype.findByName = function findByName(name) {
	        return this.find(function (item) {
	            return (item.name || item.getName()) === name;
	        });
	    };
	
	    Collection.prototype.findIndexByName = function findIndexByName(name) {
	        return this.findIndex(function (item) {
	            return (0, _isFunction2.default)(item.getName) && item.getName() === name;
	        });
	    };
	
	    Collection.prototype.addOrReplaceByName = function addOrReplaceByName(name, item) {
	    ...
	    Collection.prototype.slice = function slice() {
	        ...
	        return new this.constructor((0, _slice3.default)(this.toArray(), start, end));
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Symbol = __webpack_require__(29),
	    ...
	    equalArrays = __webpack_require__(56),
	    mapToArray = __webpack_require__(64),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getAllKeys = __webpack_require__(67);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createFind = __webpack_require__(128),
	    findIndex = __webpack_require__(129);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var toFinite = __webpack_require__(132);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseIteratee = __webpack_require__(7),
	    basePullAt = __webpack_require__(139);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseUnset = __webpack_require__(140),
	    isIndex = __webpack_require__(83);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseFlatten = __webpack_require__(146),
	    baseOrderBy = __webpack_require__(148),
	    baseRest = __webpack_require__(152),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrayMap = __webpack_require__(6),
	    baseIteratee = __webpack_require__(7),
	    baseMap = __webpack_require__(121),
	    baseSortBy = __webpack_require__(149),
	    baseUnary = __webpack_require__(87),
	    compareMultiple = __webpack_require__(150),
	    identity = __webpack_require__(117);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var compareAscending = __webpack_require__(151);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SetCache = __webpack_require__(57),
	    ...
	    cacheHas = __webpack_require__(61),
	    createSet = __webpack_require__(169),
	    setToArray = __webpack_require__(65);
